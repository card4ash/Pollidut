...
$(document).ready(function() { 	
	...
	$(function () {
	   var data = [
		    { label: "%78.75 Swapping",  data: 78.75, color: "#88bbc8"},
		    { label: "%21.25 PTR",  data: 21.25, color: "#ed7a53"}
		];
    ...
    //CM target achievement graph
	if (divElement.hasClass('pieStatsCmTarget')) {
	    $(function () {
	        var data = [
                 { label: "%90.00 Done", data: 90.00, color: "#ed7a53" },
                  { label: "%5.75 Verified", data: 5.75, color: "#cd7b03" },
                 { label: "%4.25 Not Done", data: 4.25, color: "#88bbc8" }
	        ];

	        $.plot($(".pieStatsCmTarget"), data,
            {
                series: {
                    pie: {
                        show: true,
