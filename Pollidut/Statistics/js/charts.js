...
$(document).ready(function() { 	
	...
	$(function () {
		var data = [
		    { label: "Business",  data: 38, color: "#88bbc8"},
		    { label: "Student",  data: 23, color: "#ed7a53"},
		    { label: "Puller",  data: 15, color: "#9FC569"},
		    { label: "Labour",  data: 9, color: "#bbdce3"},
		    { label: "Farmer",  data: 7, color: "#9a3b1b"},
		    { label: "Service",  data: 5, color: "#5a8022"},
		    { label: "Others",  data: 3, color: "#2c7282"}
		];
