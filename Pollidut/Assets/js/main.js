...
Modernizr.load({
  ...
  nope: '../assets/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['../assets/plugins/fix/ios-fix/ios-orientationchange-fix.js', '../assets/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
